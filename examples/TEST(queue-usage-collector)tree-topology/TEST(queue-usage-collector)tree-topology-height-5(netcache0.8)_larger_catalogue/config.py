...
# Unit second
CACHE_READ_PENALTIES = [0.03, 0.05, 0.06, 0.08, 0.1, 0.12, 0.14, 0.16, 0.18, 0.2, 0.24, 0.26 ,0.28, 0.29, 0.3, 0.32, 0.35, 0.38, 0.4, 0.5, 0.6, 0.7, 0.8, 1, 1.2, 1.5, 2, 3, 4, 5, 6, 7, 8]
CACHE_WRITE_PENALTIES = [0.05]

READ_QUEUE_SIZE_LIMITS = [2]
