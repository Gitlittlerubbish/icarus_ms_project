...
def main():
    ...
    # create plot
    tick = [0, 0.01, 0.05, 0.08, 0.09, 0.1, 0.11, 0.12, 0.13, 0.15, 0.16, 0.17, 0.18, 0.19, 0.20, 0.3, 0.4, 0.5, 0.6, 0.7, 0.8]
    ...
    plt.xlabel('READ_PENALTY (s)')
    plt.ylabel('MEAN_CACHE_HIT_RATIO')
    plt.title('MEAN_CACHE_HIT_RATIO vs READ_PENALTY')
    plt.savefig("MEAN_CACHE_HIT_RATIO vs READ_PENALTY.png")
    plt.show()
